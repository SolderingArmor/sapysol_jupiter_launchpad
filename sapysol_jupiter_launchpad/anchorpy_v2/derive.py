...
from ..anchorpy_v2.program_id import PROGRAM_ID as DISTRIBUTOR_PROGRAM_ID

V2_ROOT_MERKLE_TREE = Pubkey.from_string("DiSLRwcSFvtwvMWSs7ubBMvYRaYNYupa76ZSuYLe6D7j")
